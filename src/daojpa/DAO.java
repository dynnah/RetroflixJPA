...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void open(){
		if(manager==null){
			...
			//			properties.put(PersistenceUnitProperties.JDBC_URL, "jdbc:postgresql://localhost:5432/retroflix");
			...
			//			properties.put(PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_ACTION, "create");
			factory = Persistence.createEntityManagerFactory("retroflix-eclipselink", properties);
			//----factory = Persistence.createEntityManagerFactory("retroflix-hibernate", properties);
